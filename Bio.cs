    ...
    public partial class Bio : Form
    {
        ...
        public void timein()
        {
            using (SqlConnection con = new SqlConnection(cs2))
            {
                ...
                else if (lblmname.Text == "" )
                {
                    MessageBox.Show("Empty", "No Record Found", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
        ...
        public void timeout()
        {
            using (SqlConnection con = new SqlConnection(cs2))
            {
                ...
                else
                {
                    ...
                    string sql;
                    DataSet dss;
                    sql = "Update attendance set time_out=@TimeOUT WHERE employee_id=@ID and date ='" + date.Text + "' ";
